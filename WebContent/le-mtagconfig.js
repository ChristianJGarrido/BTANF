var lpMTagConfig = {
    ...
    'lpNumber' : sessionStorage.siteId,
...
try{
	...
	if (typeof(lpCountryID)=='undefined') {var lpCountryID = '';}
	if (typeof(lpLanguage)=='undefined') {var lpLanguage= sessionStorage.language; }
	if (typeof(lpUnit)=='undefined')	{var lpUnit= sessionStorage.unit;	}
	if(typeof(lpAddVars)!='undefined') { lpAddVars('page','unit', sessionStorage.unit); }	
	if(typeof(lpAddVars)!='undefined') { lpAddVars('page','language', sessionStorage.language); }	
